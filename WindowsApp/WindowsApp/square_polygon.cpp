...
[[nodiscard]] bool Square_Polygon::createVertexBuffer(const Dx12& dx12) noexcept {
	...
	Vertex squareVertices[] = {
		{   {-0.2f, 0.3f, 0.0f}, {1.0f, 1.0f, 1.0f, 1.0f}}, //左上頂点（赤色）
		{  {-0.2f, -0.2f, 0.0f}, {1.0f, 1.0f, 1.0f, 1.0f}}, //左下頂点（赤色）
		{ {0.2f, -0.2f, 0.0f}, {1.0f, 1.0f, 1.0f, 1.0f}}, //右下頂点（赤色）
		{{0.2f, 0.3f, 0.0f}, {1.0f, 1.0f, 1.0f, 1.0f}}  //右上頂点（赤色）
	};
