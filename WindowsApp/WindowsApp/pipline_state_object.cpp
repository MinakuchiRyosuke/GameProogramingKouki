...
[[nodiscard]] bool PiplineStateObject::create(const Dx12& dx12, const Shader& shader, const RootSignature& rootSignature) noexcept {
    ...
    auto res = dx12.getDevice()->CreateGraphicsPipelineState(&psoDesc, IID_PPV_ARGS(&pipelineState_));
    if (FAILED(res)) {
